...
/**
 * Created by Asif Isthiaq on 8/18/2016.
 */
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private final ArrayList<MyHotel> wishList = new ArrayList<>();
    ...
    public void addWishes(MyHotel wish) {
    ...
    //Get all wishes
    public ArrayList<MyHotel> getWishes() {
