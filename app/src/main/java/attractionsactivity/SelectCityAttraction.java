...
public class SelectCityAttraction extends AppCompatActivity {

    ListView list_view1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_select_city_attraction);
        ...
        list_view1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(ClickedValue=="DHAKA"){
                    Intent i = new Intent(SelectCityAttraction.this, SelectAttractionActivity.class); ///
                    startActivity(i);
                }
            }
        });
